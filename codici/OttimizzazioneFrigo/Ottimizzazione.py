...
orePannello=(mdates.date2num(pannello.index)-mdates.date2num(pannello.index[0]))*86400
...
ValoriPannello=pannello.loc[pannello.index].values
ottimizzazione=[]
...
ax1.plot(orePannello,ValoriPannello,label="pannello")
